...
const Hero: NextPage = () => {
  ...
  return (
    <section className="h-dvh snap-start w-full bg-luma-dark relative">
      <div className="absolute inset-0 z-10 bg-gradient-to-b h-full from-luma-dark/50 via-luma-dark/20 to bg-luma-dark/40 py-[60px] px-8 flex flex-col justify-between">
        <div>
          <h1 className="font-bigilla leading-[40px] text-white text-5xl mb-3 mt-5">
