...
const ButtonOutlinedLight: FC<Props> = ({
  title,
  icon,
  isLoading,
  className = "",
  ...
  return (
    <button
      ...
      } ${className} border border-nirvaya-light-brown text-white hover:bg-white hover:text-nirvaya-primary rounded-full min-w-24 backdrop-blur-sm px-5 py-3 flex transition-colors ease-in-out duration-700 ${
