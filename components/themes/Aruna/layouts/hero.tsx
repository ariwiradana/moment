...
const HeroComponent: FC<Props> = (props) => {
  ...
  return (
    <section className="relative h-screen sm:h-svh overflow-hidden">
      <div className="fixed top-0 right-0 w-full xl:w-[40vw] 2xl:w-[30vw] overflow-hidden">
        {video && video?.length > 0 ? (
          <div
            className="h-screen sm:h-svh w-full"
            data-aos="zoom-out"
            data-aos-delay="500"
          >
          ...
          <Swiper
            ...
            effect="fade"
            speed={2000}
            className="w-full transition-transform h-screen sm:h-svh"
            spaceBetween={0}
            slidesPerView={1}
      ...
      >
        {props.state.open && (
          <div className="h-screen sm:h-svh flex flex-col max-w-screen-sm lg:max-w-screen-lg mx-auto py-[60px] md:py-[100px] px-8 md:px-12 w-full">
            <div>
              <h1
                data-aos="fade-up"
                data-aos-delay="200"
