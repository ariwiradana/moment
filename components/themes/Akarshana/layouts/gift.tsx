  ...
  if (
    ...
    return (
      <section className="relative bg-white">
        <div
          className="relative z-10 h-full w-full px-6 py-16 bg-aakarshana-primary bg-opacity-5"
          data-aos="fade-up"
        >
          ...
          <div className="flex justify-center" data-aos="zoom-out-up">
            <div
              className={`h-52 lg:h-56 md:w-96 w-full bg-aakarshana-primary bg-opacity-15 p-8 rounded-2xl flex flex-col justify-between shadow-lg relative ${afacad.className}`}
            >
              <Image
                sizes="100px"
                alt={`img-card`}
              ...
              <div className="flex justify-end relative z-10">
                <h1
                  className={`text-3xl uppercase font-bold text-aakarshana-primary`}
                >
                  {props.state.client?.gift_bank_name}
                </h1>
              </div>
              <div className="relative z-10">
                <div>
                  <p className="text-base leading-5 text-aakarshana-primary">
                    {props.state.client?.gift_account_name}
                  </p>
                ...
                <button
                  ...
                  className="bg-aakarshana-primary outline-none text-white px-2 rounded-lg text-sm flex items-center gap-x-1 mt-3 relative z-10"
                >
