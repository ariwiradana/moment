...
const Button: FC<Props> = ({
  ...
  return (
    <button
      ...
      } ${className} text-white rounded-full min-w-24 bg-aakarshana-primary pl-4 pr-3 py-3 lg:pl-4 lg:pr-3 text-base flex ${
    ...
    >
      ...
      <div className="w-5 lg:w-8 h-5 lg:h-8 rounded-full bg-white text-aakarshana-primary flex justify-center items-center">
        <span>
