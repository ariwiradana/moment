...
const Button: FC<Props> = ({
  ...
  return (
    <button
      ...
      } ${className} text-samaya-primary rounded-full min-w-24 bg-samaya-primary/20 backdrop-blur px-5 py-2 md:py-3 text-sm md:text-base flex hover:bg-samaya-primary transition-colors ease-in-out duration-500 hover:text-samaya-dark ${
