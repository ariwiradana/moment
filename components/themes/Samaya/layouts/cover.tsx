  ...
  return (
    <>
      ...
      >
        <div
          data-aos="fade-in"
          className="flex h-dvh flex-col items-center justify-between relative z-30 py-[60px] md:py-[100px] px-8 bg-gradient-to-t from-samaya-dark/95 from-[15%] md:from-[20%] via-samaya-dark/0 to-samaya-dark/95"
        >
          <div>
            <p
              data-aos="fade-up"
