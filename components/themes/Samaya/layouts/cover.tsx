  ...
  return (
    <>
      ...
      >
        <div
          data-aos="fade-in"
          className="flex h-dvh flex-col items-center justify-between relative z-30 py-[60px] md:py-[100px] px-8 bg-gradient-to-b from-samaya-dark/90 via-transparent to-samaya-dark to-[90%]"
        >
          <div>
            <p
              data-aos="fade-up"
