...
const ButtonDark: FC<Props> = ({
  ...
  return (
    <button
      ...
      } ${className} bg-luma-primary text-white hover:bg-luma-primary/80 rounded-full min-w-24 backdrop-blur-sm px-4 py-3 flex transition-colors ease-in-out duration-700 ${
