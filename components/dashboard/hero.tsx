...
const HeroComponent = () => {
  ...
  return (
    <section
      id="section1"
      className="min-h-svh md:h-full md:min-h-[70vh] lg:h-dvh w-full mt-10 bg-white flex flex-col justify-center max-w-screen-xl mx-auto gap-10 p-4 md:p-12 lg:p-0"
    >
