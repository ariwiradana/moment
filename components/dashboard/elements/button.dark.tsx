...
const ButtonDark: FC<ButtonDarkProps> = ({
  title = undefined,
  className = "",
  icon,
  size = "large",
  ...
  return (
    <button
      ...
      className={`${afacad.className} ${
        className ?? ""
      } flex items-center text-white justify-center whitespace-nowrap hover:bg-opacity-90 bg-dashboard-dark transition duration-500 ${
