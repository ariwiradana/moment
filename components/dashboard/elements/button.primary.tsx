  ...
  return (
    <button
      ...
      className={`${afacad.className} ${
        props.className ?? ""
      } flex items-center text-dashboard-secondary font-medium bg-dashboard-primary bg-opacity-95 transition duration-500 hover:bg-opacity-100 justify-start ${buttonStyles(
        props.size ?? "large"
      )} ${
        props.isloading &&
