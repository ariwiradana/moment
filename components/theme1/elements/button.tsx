...
const Button: FC<Props> = (props) => {
  return (
    <button
      {...props}
      className={`${comforta.className} text-white bg-theme1-primary pl-4 pr-3 py-3 lg:pl-6 lg:pr-4 rounded-full text-sm flex items-center gap-x-3 lg:gap-x-4 relative overflow-hidden shadow-sm`}
    >
