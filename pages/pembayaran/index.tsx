...
const DashboardPayment: FC = () => {
  ...
  return (
    <Layout>
      <Seo
        url="https://momentinvitations.com/pembayaran"
        title="Pembayaran | Moment"
        description="Pembayaran undangan digital Moment"
        keywords="pembayaran, undangan digital, undangan online, undangan pernikahan, undangan metatah, moment invitation, moment"
