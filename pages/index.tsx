  ...
  return (
    <Layout>
      <Seo
        ...
        title="Undangan Digital Bali | Pernikahan & Mempandes | Moment"
        description="Buat undangan digital elegan di Bali dengan desain minimalis dan modern. Moment Invitation menyediakan undangan online untuk pernikahan dan mempandes Anda. Praktis, cepat, dan bisa disesuaikan sesuai tema impian Anda."
